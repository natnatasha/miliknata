...
<div class="row">
	...
	<?php 	
		if (isset($_POST['cetak'])) {
			echo "<script>window.location.href='?page=bkprombel&rombel=$_POST[rombel]'</script>";
		}
	?>
	<div class="col-md-9">
		<div class="tile">
			...
			<div class="tile-body">
				<table class="table table-hover table-bordered" id="sampleTable">
					...
					<?php 
						$sql = mysqli_query($con, "SELECT * FROM query_bkp WHERE rombel='$_GET[rombel]' GROUP BY nis");
						$no = 1;
