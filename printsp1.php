<?php 
 ...
 <body>
 	...
 	<div class="container" style="margin-top: 163px;">
 		...
 		<br>
 		<h1  class="text-center"><u>SURAT PERINGATAN I</u></h1>
 		<br>
 		<?php 
 			@$bulan = $_GET['bln'];
	        switch ($bulan) {
 		...
 		<br>
 		<div class="font">
 		<p>Berdasarkan butir kesepahaman antara Peserta Didik dan SMK Wikrama Bogor, Peserta Didik yang tertera di bawah ini:</p>
		...
		<br>
		<p>Telah melakukan pelanggaran yang patut mendapatkan Surat Peringatan 1 (Satu). Pihak orang tua diminta lebih memperhatikan perkembangan Peserta Didik tersebut demi terciptanya suasana belajar yang kondusif.</p>
		<br>
		<br>
