<?php 
 ...
 <body>
 	...
 	<div class="container" style="margin-top: 163px;">
 		...
 		<br>
 		<h1  class="text-center"><u>SURAT PERINGATAN III</u></h1>
 		<br>
 		<?php 
 			@$bulan = $_GET['bln'];
	        switch ($bulan) {
 		...
 		<br>
 		<div class="font">
 		<p>Menindaklanjuti Surat Peringatan Kedua, Peserta Didik yang tertera di bawah ini:</p>
		...
		<br>
		<p>Telah melakukan pelanggaran yang patut mendapatkan Surat Peringatan 3 (tiga). Pihak orang tua diminta lebih memperhatikan perkembangan Peserta Didik tersebut demi terciptanya suasana belajar yang kondusif.</p>
		<br>
		<br>
