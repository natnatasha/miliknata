	...
	<div class="container" style="font-size: 20px;">
		...
		<table class="table table-hover table-bordered">
			...
			<tbody>
				...
				<?php $no++; }  ?>
				<?php 
					$ha = mysqli_query($con, "SELECT SUM(skor) as reward FROM tb_input WHERE nis='$_GET[nis]' AND kelompok='H'");
		...
		<table class="table table-hover table-bordered">
			...
			<tbody>
				...
				<?php $no++; }  ?>
				<?php 
					$pe = mysqli_query($con, "SELECT SUM(skor) as punishment FROM tb_input WHERE nis='$_GET[nis]' AND kelompok='P'");
