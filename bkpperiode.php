...
<div class="row">
	...
	<?php 	
		...
		echo "<script>window.location.href='?page=bkpperiode&rayon=$_POST[rayon]&tgl1=$_POST[tgl1]&tgl2=$_POST[tgl2]'</script>";
		}
	?>	
	<div class="col-md-9">
		<div class="tile">
			...
			<div class="tile-body">
				<table class="table table-hover table-bordered" id="sampleTable">
					...
					<?php 
						$sql = mysqli_query($con, "SELECT * FROM query_bkp WHERE rayon='$_GET[rayon]' AND tgl BETWEEN '$_GET[tgl1]' AND '$_GET[tgl2]' GROUP BY nis");
						$no = 1;
